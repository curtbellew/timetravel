...
define(['knockout', 'ojs/ojknockout', 'ojs/ojtable', 'ojs/ojarraydataprovider'],
 function(ko) {
    ...
    var deptArray = [
        ...
        {UserId: "curt@bellew.com", TripName: 'Birhday', AccomidationId: "Wonderful", FoodId: "Awesome"},
        ...
        {UserId: "charles@adams.com", TripName: 'Y2K', AccomidationId: "Awesome", FoodId: "Good"},
        {UserId: "charles@adams.com", TripName: 'Surfing', AccomidationId: "Awesome", FoodId: "Decent"},
